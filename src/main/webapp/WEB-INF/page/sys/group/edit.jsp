...
<body>
	<s:form name="form1" method="post"
		action="sysUserGroupAction!update.action" >
		<s:hidden name="sysUserGroupId"></s:hidden>
		<div class="mtitle">
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><s:textfield name="name" cssClass="input" cssStyle="width:90%"></s:textfield>
								</td>
								<td>部门负责人</td>
								<td><%--<input name="principal" type="text" class="input"
									style="width:90%">
									--%><s:textfield name="principal" cssClass="input" cssStyle="width:90%"></s:textfield>
								</td>
							</tr>
							<tr>
								<td height="40" valign="top">部门职能</td>
								<td colspan="3">
								<s:textarea name="incumbent" rows="3" cssStyle="width:96%"></s:textarea>
								</td>
							</tr>
							<tr>
								<td height="40" valign="top">备注</td>
								<td colspan="3"><%--<textarea name="remark" rows="3"
										id="remark" style="width:96%"></textarea>
										--%><s:textarea name="remark" rows="3" cssStyle="width:96%"></s:textarea>
								</td>
							</tr>
						</table>
					</div></td>
