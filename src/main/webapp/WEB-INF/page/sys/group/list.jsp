...
<body>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<th class="th_head">
				...
				<div id="menuTitle1" style="font-weight:bold">部门搜索</div></th>
			<th class="th_head"></th>
		</tr>
		<tr>
			<td colspan="2">
				<s:form name="form1" method="post"
					action="sysUserGroupAction!list.action">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						name="base" id="base">
						<tr>
							<td width="38%" nowrap="nowrap">部门名称：
								<s:textfield name="name" id="name" cssStyle="width:140px"></s:textfield></td>
	...
	<div class="control">
		...
		<button type='button' class='button'
			onMouseOver="this.className='button_over';"
			onMouseOut="this.className='button';"
			onClick="forward('${pageContext.request.contextPath}/sysUserGroupAction!add.action')">
			<img
	...
	<div class="border">
		...
		<s:form name="form2" method="post"
			action="sysUserGroupAction!delete.action">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<s:iterator value="%{#request.sysUserGroups}" var="sysUserGroup">
						<tr>
							<td><!-- <input type="checkbox" name="ids" value="12"
								...
								<s:checkbox name="ids" cssClass="checkbox" fieldValue="%{#sysUserGroup.sysUserGroupId}" onclick="changeCheckCount();"></s:checkbox>
								</td>
							<td><a
								href="${pageContext.request.contextPath}/sysUserGroupAction!edit.action?sysUserGroupId=<s:property
										value="%{#sysUserGroup.sysUserGroupId}" />"><s:property
										value="%{#sysUserGroup.name}" /> </a>
							</td>
							<td><s:property value="%{#sysUserGroup.principal}" />
							</td>
							<td><s:property value="%{#sysUserGroup.remark}" />
							</td>
							<td><a
								href="javascript:OpenWin('${pageContext.request.contextPath}/sys/group/usersInGroup.jsp?id=12')">设置</a>
							</td>
						</tr>
					</s:iterator>
				</s:if>
